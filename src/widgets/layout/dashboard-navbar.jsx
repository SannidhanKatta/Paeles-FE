    ...
    >
      <div className="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
        <div className="capitalize">
          <Breadcrumbs
            className={`bg-transparent dark:text-gray-300 p-0 transition-all ${
              fixedNavbar ? "mt-1" : ""
            }`}
          >
            <Link to={`/${layout}`}>
              <Typography
                variant="small"
                color="blue-gray"
                className="font-bold opacity-50 transition-all hover:text-gray-500 hover:opacity-100 text-gray-900"
              >
                {layout}
              </Typography>
            </Link>
