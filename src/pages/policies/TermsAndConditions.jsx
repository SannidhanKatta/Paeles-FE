...
const TermsAndConditions = () => {
    return (
        <div className="max-w-4xl mx-auto px-4 py-8">
            <h1 className="text-3xl font-bold mb-8 underline">TERMS AND CONDITIONS</h1>

            <div className="space-y-6 text-base">
                <p>
                    This website is operated by HANDY BASKET(OPC) PRIVATE LIMITED. Throughout the site, the terms "we", "us" and "our" refer to HANDY BASKET(OPC) PRIVATE LIMITED. HANDY BASKET(OPC) PVT LTD offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
                </p>
                ...
                <div>
                    <h2 className="text-xl font-semibold mb-4">ONLINE STORE TERMS</h2>
                    <p className="mb-4">
                ...
                <div>
                    ...
                    <p className="mb-4">
                        You agree not to exploit any portion of the Service, use of the Service, or access to the Service or any content on the website through which the Service is provided, without express written permission by us.
                    </p>
                    <p className="mb-4">
                ...
                <div>
                    <h2 className="text-xl font-semibold mb-4">ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h2>
                    <p>
                        We are not responsible if information made available on this site is not accurate, complete or current. The material on this site is provided for general information only and should not be relied upon or used as the sole basis for making decisions without consulting primary, more accurate, more complete or more timely sources of information. Any reliance on the material on this site is at your own risk.
                    </p>
                    <p>
                        This site may contain certain historical information. Historical information, necessarily, is not current and is provided for your reference only. We reserve the right to modify the contents of this site at any time, but we have no obligation to
                ...
                <div>
                    <h2 className="text-xl font-semibold mb-4">PRODUCTS OR SERVICES (if applicable)</h2>
                    <p>
                ...
                <div>
                    <h2 className="text-xl font-semibold mb-4">ACCURACY OF BILLING AND ACCOUNT INFORMATION</h2>
                    <p>
                    ...
                    <p className='mb-4'>
                        For more details, please review our Exchange Policy.
                    </p>
                </div>

                <div>
                    <h2 className="text-xl font-semibold mb-4">OPTIONAL TOOLS</h2>
                    <p className='mb-4'>
                ...
                <div>
                    ...
                    <p className='mb-4'>
                        Third-party content, products and Services available via our Service may include materials from third parties.
                    </p>
                    <p className='mb-4'>
                ...
                <div>
                    <h2 className="text-xl font-semibold mb-4">USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h2>
                    <p className='mb-4'>
                ...
                <div>
                    <h2 className="text-xl font-semibold mb-4">ERRORS, INACCURACIES AND OMISSIONS</h2>
                    <p className='mb-4'>
                ...
                <div>
                    <h2 className="text-xl font-semibold mb-4">DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h2>
                    <p className='mb-4'>
                ...
                <div>
                    ...
                    <p className='mb-4'>
                        You agree to indemnify, defend and hold harmless HANDY BASKET (OPC) PRIVATE LIMITED and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, Service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p className='mb-4'>
                        Questions about the Terms of Service should be sent to us at support@paeless.com.
