...
const PrivacyPolicy = () => {
    return (
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <div>
                <h2 className="text-xl font-semibold mb-4">How We Collect and Use Your Personal Information</h2>
                <p className='mb-4'>
            ...
            <div>
                <h2 className="text-xl font-semibold mb-4">What Personal Information We Collect</h2>
                <p className='mb-4'>
            ...
            <div>
                <h2 className="text-xl font-semibold mb-4">Information We Collect Directly from You</h2>
                <p className='mb-4'>
                    Information that you directly submit to us through our Services may include:
                </p>
                <ul className='mb-4 list-disc pl-5'>
                    <li className='mb-2'><strong>Basic contact details</strong> including your name, address, phone number, email.</li>
                    <li className='mb-2'><strong>Order information</strong> including your name, billing address, shipping address, payment confirmation, email address, phone number.</li>
                    <li className='mb-2'><strong>Account information</strong> including your username, password, security questions.</li>
                    <li className='mb-2'><strong>Shopping information</strong> including the items you view, put in your cart or add to your Wishlist.</li>
                    <li className='mb-2'><strong>Customer support information</strong> including the information you choose to include in communications with us, for example, when sending a message through the Services.</li>
                </ul>
                <p className='mb-4'>
            ...
            <div>
                <h2 className="text-xl font-semibold mb-4">Information We Collect through Cookies</h2>
                <p className='mb-4'>
            ...
            <div>
                <h2 className="text-xl font-semibold mb-4">How We Use Your Personal Information</h2>
                <p className='mb-4'>
                ...
                <p className='mb-4'>
                    ...
                    interests in order to be responsive to you, to provide effective services to you,
                    and to maintain our business relationship with you.
                </p>
            </div>

            <div>
                <h2 className="text-xl font-semibold mb-4">How We Disclose Personal Information</h2>
                <p className='mb-4'>
                    In certain circumstances, we may disclose your personal information to third parties for legitimate purposes subject to this Privacy Policy. Such circumstances may include:
                </p>
                <ul className='mb-4 list-disc pl-5'>
                    <li className='mb-2'>With vendors or other third parties who perform services on our behalf (e.g., IT management, payment processing, data analytics, customer support, cloud storage, fulfilment and shipping).</li>
                    <li className='mb-2'>With business and marketing partners, to provide services and advertise to you. Our business and marketing partners will use your information in accordance with their own privacy notices.</li>
                    <li className='mb-2'>When you direct, request us or otherwise consent to our disclosure of certain information to third parties, such as to ship your products or through your use of social media widgets or login integrations, with your consent.</li>
                    ...
                    <li className='mb-2'>In connection with a business transaction such as a merger or bankruptcy, to comply with any applicable legal obligations (including to respond to subpoenas, search warrants and similar requests), to enforce any applicable terms of service, and to protect or defend the Services, our rights, and the rights of our users or others.</li>
                </ul>
            </div>
            ...
            <div>
                <h2 className="text-xl font-semibold mb-4">Third Party Websites and Links</h2>
                <p className='mb-4'>
            ...
            <div>
                ...
                <p className='mb-4'>
                    We will not discriminate against you for exercising any of these rights. We may need to collect information from you to verify your identity, such as your email address or account information, before providing a substantive response to the request. In accordance with applicable laws, you may designate an authorized agent to make requests on your behalf to exercise your rights. Before accepting such a request from an agent, we will require that the agent provide proof you have authorized them.
                </p>
            </div>
            ...
            <div>
                ...
                <p className='mb-4'>
                    Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call +917337351664 or email us at support@paeless.com or contact us at HANDY BASKET (OPC) PRIVATE LIMITED, H-No: 2-161/1, Amangal, Hyderabad, Telangana, India - 509321.
                </p>
            </div>
            ...
            <div>
                ...
                <p className='mb-4'>
                    HANDY BASKET (OPC) PRIVATE LIMITED<br />
                    email us at support@paeless.com<br />
                    <strong>WhatsApp: +917337351664</strong><br />
                    <strong>H-No: 2-161/1, Amangal, Hyderabad, Telangana, India - 509321</strong>
                </p>
            </div>
        </div>
    );
