        ...
        <div className=" flex flex-col md:flex-row gap-3 md:gap-10 mb-8 md:mb-12 ">
          ...
          <div className=" flex flex-col">
            <h3 className=" text-[20px] md:text-[26px] uppercase text-[#363F4D]  dark:text-gray-400  font-[700] plus-jakarta ">
              WELCOME TO{" "}
              <span className=" text-[#FF7004]">PAELES.</span>
            </h3>
            <p className=" text-[12.5px] md:text-[13.6px] font-[400] md:w-[65%] text-justify mt-2 md:mt-4 mb-5 md:mb-8 text-[#7A7A7A] dark:text-gray-600">
              PAELES provides a thorough understanding of how the idea of blending style with comfort and affordability came to be. By focusing on high-quality footwear and clothing, PAELES has built a reputation for offering products that meet the needs of every customer. Their approach is grounded in the belief that fashion should never sacrifice comfort, and comfort should never come at the cost of style. PAELES ensures that every item they offer is crafted with care, using premium materials that promise durability, support, and all-day wearability. Whether you're looking for everyday footwear or clothing that suits your lifestyle, PAELES delivers dependable, stylish solutions that don't break the bank. Their system revolves around providing an exceptional balance of quality, comfort, and value, making them the trusted brand for those who seek both practicality and style in every step they take.
            </p>
            ...
            <p className=" text-[12.5px] md:text-[13.6px] font-[400] md:w-[65%] mt-2 md:mt-4 text-justify text-[#7A7A7A] dark:text-gray-600">
              PAELES offers a deep insight into how the idea of merging style, comfort, and affordability in fashion first came to life. They provide a comprehensive look at the philosophy that drives their product range, showcasing how this vision transforms everyday clothing and footwear into an experience of both practicality and elegance. PAELES unveils the true essence of crafting products that not only look good but also feel good, supporting your every movement with the comfort you deserve. In this account, they explore the perfect balance between timeless design and modern sensibility, placing emphasis on reliability and durability without compromising on style. PAELES invites you to discover the essence of what it means to live well, dressed well, and move through life with ease, offering you more than just products, but a philosophy that blends quality, comfort, and a thoughtful approach to fashion.
            </p>
          </div>
        </div>
